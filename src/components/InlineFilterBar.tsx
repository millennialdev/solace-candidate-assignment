...
function InlineFilterBarComponent({
  ...
  const activeFilterCount =
    ...
    filters.selectedDegrees.length +
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      localStorage.setItem("filterBarExpanded", isExpanded.toString());
    }
  }, [isExpanded]);
      ...
      <div className="p-4 sm:p-6">
        <div className="flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-3 text-lg font-semibold text-gray-900 hover:text-blue-600 transition-colors group"
          >
            ...
            <svg
              className={`w-5 h-5 text-gray-500 group-hover:text-blue-600 transition-transform duration-200 ${
